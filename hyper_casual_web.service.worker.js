...
/** @type {string} */
const CACHE_VERSION = '1732728504|157895123434';
/** @type {string} */
const CACHE_PREFIX = 'HyperCasual_Zenv-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'hyper_casual_web.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["hyper_casual_web.html","hyper_casual_web.js","hyper_casual_web.offline.html","hyper_casual_web.icon.png","hyper_casual_web.apple-touch-icon.png","hyper_casual_web.worker.js","hyper_casual_web.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["hyper_casual_web.wasm","hyper_casual_web.pck"];
